    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader'}),
                ...
                $uploadedGalleryContainer = $('<div>', {class: 'popup-gallery'}),

                $uploadedContainer = $('<div>', {class: 'uploaded'}).appendTo($uploadedGalleryContainer),

                $uploadedGalleryContainer2 = $uploadedGalleryContainer.appendTo($container),
        ...
        let createImg = function (src, id) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                // Create the img tag
                $aimg = $('<a>', {href: src}),
                $img = $('<img>', {src: src}).appendTo($aimg),

                $aimgS = $aimg.appendTo($container),
