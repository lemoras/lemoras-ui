...
demo = {
  ...
  showSwal: function(type) {
    ...
    } else if (type == 'profil-picture') {
        Swal.fire({
            title: 'Onayliyor musunuz?',
            text: "Sectiginiz dosya ile profil resminiz degistirilecektir!",
            type: 'Dikkat',
            showCancelButton: true,
            confirmButtonClass: 'btn btn-success',
            cancelButtonClass: 'btn btn-danger',
            confirmButtonText: 'Evet, profil resmimi guncelle!',
            buttonsStyling: false
        }).then((result) => {
            if (result.value) {
                Swal.fire({
                    title: 'Bilgi!',
                    text: 'Profil fotografiniz guncellendi.',
                    type: 'success',
                    confirmButtonClass: 'btn btn-success',
                    buttonsStyling: false
                });
  ...
  showNotification: function(from, align) {
    ...
    showNotificationSelf: function (message) {
        color = 'primary';
